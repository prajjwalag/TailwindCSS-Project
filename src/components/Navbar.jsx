    ...
    return (
        <nav className="flex p-6 items-center justify-between lg:p-8">
            ...
            <div id="auth-container" className="flex gap-8 items-center">
                ...
                <button className="cursor-pointer font-bold text-xl text-black bg-yellow-400 text px-6 py-3 rounded-xl hover:bg-yellow-300 hover:-translate-y-1 transition-all">Sign up</button>
            </div>
        </nav>
    );
};
